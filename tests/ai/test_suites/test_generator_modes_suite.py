...
from app.prompts import BRUTALLY_HONEST_PROMPT, GENERATOR_SYSTEM_PROMPT, combine_prompts

from ..eval_datasets.generator_brutally_honest_dataset import generator_brutally_honest_dataset


@pytest.fixture(scope="module")
def brutally_honest_generator_chain():
    final_prompt = combine_prompts(GENERATOR_SYSTEM_PROMPT, BRUTALLY_HONEST_PROMPT)
...
@pytest.mark.parametrize("test_spec", [pytest.param(spec, id=spec["id"]) for spec in generator_brutally_honest_dataset])
